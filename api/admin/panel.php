    ...
    <main class="admin-main">
        ...
        <?php if ($pendientes > 0): ?>
            <section class="admin-alert">
                ...
                <a href="/api/admin/GestionesAdmin/GestionReservas.php">Ver reservas</a>
            </section>
        <?php endif; ?>
        ...
        <section class="admin-actions">
            <a href="/api/admin/GestionesAdmin/GestionServicios.php">Gestionar Servicios</a>
            <a href="/api/admin/GestionesAdmin/GestionEquipo.php">Gestionar Equipo</a>
            <a href="/api/admin/GestionesAdmin/GestionReservas.php">Ver Reservas</a>
            <a href="/api/admin/GestionesAdmin/GestionGaleria.php">Gestionar Galería</a>
            <a href="/api/admin/GestionesAdmin/GestionBlog.php">Editar Blog</a>
            <a href="/api/admin/GestionesAdmin/GestionUbicacion.php">Actualizar Ubicación</a>
        </section>
    </main>
