...
<section class="admin-layout">
    ...
    <main class="admin-main">
        ...
        <p class="admin-subtitle">Administra las citas de la barbería.</p>
                    ...
                    <tbody>
                        <?php foreach ($reservas as $reserva): ?>
                            <tr>
                                ...
                                <td>
                                    <a href="cambiar_estado_reserva.php?id=<?= $reserva['reserva_id'] ?>&estado=confirmada">Aceptar</a>
                                    <a href="cambiar_estado_reserva.php?id=<?= $reserva['reserva_id'] ?>&estado=cancelada">Cancelar</a>
                                    <a href="eliminar_reserva.php?id=<?= $reserva['reserva_id'] ?>">Eliminar</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
